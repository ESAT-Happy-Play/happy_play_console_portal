...
import { mockAssets, mockDeposits } from '../../../helper/mocks';
    ...
    return (
        <div className="home">
            <div className="header">
                ...
                >New Asset <AddIcon /></Button>
            </div>

            <AssetsTable data={mockAssets} />
            ...
            {openSuccess &&
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText>Successfully created asset!</DialogContentText>
                    </DialogContent>
