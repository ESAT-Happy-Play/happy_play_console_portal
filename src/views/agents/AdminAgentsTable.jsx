...
const AdminAgentsTable = ({ loadingCallback }) => {
    ...
    <div className="div-table">
      <div className="div-container">
        <div className="div-head">
          <h2 className="title" style={{fontSize:'20px'}}>Agents List</h2>
        </div>
        {
          (isUserDetails) ? 
          ...
          <div style={{ padding:'15px' }}>
              ...
              <CustomTable
                  // headAlign="left"
                  headers={["Name", "Company", "Branch", "Agents", "Players", "Status", "Regisration Date", ""]}
                  pagination={
                      <StyledPagination
