...
const PlayersTable = ({ companyObjId, companyId, loadingCallback}) => {
  ...
  useEffect( () => {
    handleInitData().then((res) => {
      setDisplayList(res.playersList);
    ...
    <div className="div-table">
      <div className="div-container">
        <div className="div-head">
          <h2 className="title" style={{fontSize:'20px'}}>Players List</h2>
        </div>
        {
          (isUserDetails) ? 
            <UserProfile objData={selectedUser} agentCount={agentCount} playerCount={playerCount} hasDownline={false} callBack={handeBackToList} />
          :
          <div style={{ padding:'15px' }}>
              ...
              <CustomTable
                  // headAlign="left"
                  headers={["Name", "mobileNumber", "Status", "Regisration Date", ""]}
                  pagination={
                      <StyledPagination
