...
const CommissionCustomTable = ({ headers, style, children, pagination, headAlign = 'center' }) => {
    return (
        <>
                    ...
                    <StyledTableHead>
                        <TableRow>
                            {headers.map((header, i) => (
                                <StyledTableHeaderCell align={headAlign} key={i}>{header}</StyledTableHeaderCell>
                            ))}
                        </TableRow>
                    </StyledTableHead>
                    <TableBody>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding:'25px', borderTop:'2px solid #4845d2' }}>
                <b>Feb 29, 2024</b>
                <b>22,000.00</b>
            </div>
            {pagination &&
...
export default CommissionCustomTable;