...
import AdminGameResultTableData from './AdminGameResultTableData';
import { ChunckArry } from "../../../helper/Helpers";

const AdminGameResultList = ({ 
  SearchResults,
  ChangePage,
  RowsPerPage,
  pageNumber, 
  ...
  const results = SearchResults.map((obj, index ) => <AdminGameResultTableData 
    key={ index }
    onView= { handleOnView }
    objct={obj}
  />)
...
export default AdminGameResultList
