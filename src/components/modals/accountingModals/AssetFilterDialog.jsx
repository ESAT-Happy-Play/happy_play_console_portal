...
import { drawTypeList, mockCompanies, mockBranches, mockStatus, assetTypes, } from "../../../helper/mocks";
...
const AssetFilterDialog = ({
    ...
    const [type, setType] = useState(initFilters?.type?.value ?? "");
    ...
    const handleSubmit = () => {
        ...
        if (type != "")
            newFilters.push({ key: "type", label: assetTypes[type - 1].name, value: type, id: assetTypes[type - 1].id });
                        ...
                        <FormControl fullWidth size="small">
                            <Select
                                ...
                                renderValue={(selected) => {
                                    ...
                                    return assetTypes[selected - 1]?.name;
                                }}
                                sx={selectBorderStyle}
                            >
