...
import { mockCompanies, mockBranches, mockStatus } from "../../../helper/mocks";
import { Button } from "@mui/material";
import CheckIcon from "@mui/icons-material/Check";
import { AdapterDayjs } from "@mui/x-date-pickers/AdapterDayjs";
import { DatePicker, LocalizationProvider } from "@mui/x-date-pickers";

const BettFilterDialog = ({
    open,
    onClose,
    onSubmit,
    initFilters,
    ...
    const handleSubmit = () => {
        ...
        if (status != "")
            newFilters.push({ key: "status", label: betStatus[status - 1].name, value: status, id: betStatus[status - 1].id });
                        ...
                        <FormControl fullWidth size="small">
                            <Select
                                ...
                                renderValue={(selected) => {
                                    ...
                                    return betStatus[selected - 1]?.name;
                                }}
                                sx={selectBorderStyle}
                            >
...
export default BettFilterDialog;