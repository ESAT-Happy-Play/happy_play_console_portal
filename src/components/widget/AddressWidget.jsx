...
const AddressWidget = ({register, errors, nextrequired, callback, defaultData}) => {
    ...
    <>
        <div className="divContent">
            ...
            <div className="right">
                ...
                { 
                    ...register("region", ((nextrequired)) ? { required: true } : { required: false } ) 
                }
                error={ !!errors.region }
            ...
            <div className="right">
                ...
                { 
                    ...register("province", ((nextrequired)) ? { required: true } : { required: false } ) 
                }
            ...
            <div className="right">
                <TextField 
                    ...
                    { 
                    ...register("municipality", ((nextrequired)) ? { required: true } : { required: false }) 
                    }
            ...
            <div className="right">
                ...
                { 
                    ...register("barangay", ((nextrequired)) ? { required: true } : { required: false } ) 
                }
