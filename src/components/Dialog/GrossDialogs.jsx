...
export default function GrossDialogs({ isOpen, setOpen, value }) {
    ...
    return (
        <React.Fragment>
            <Dialog
                ...
                onClose={handleClose}
            >
                <DialogTitle style={{ color: COLORS.violetMain }}>Change Gross Percentage</DialogTitle>
                <DialogContent
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>Note: Gross Percentage will be set to</DialogContentText>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>New Gross Percentage added!</DialogContentText>
                </DialogContent>
                <DialogActions sx={{ justifyContent: "center" }}>
