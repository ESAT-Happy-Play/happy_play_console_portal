...
const ApproveCreditRequest = ({ isOpenAdd, handleCloseAdd, handleCallback, objData, objUser }) => {
  ...
  const handleApproveCreditOkay = async () => {
    ...
    let response = await PATCHFetch(`${process.env.REACT_APP_API_URL}/credits/requests/${requestId}?isapprove=1`, {});
  ...
  return (
    <>
            ...
            <form onSubmit={ handleSubmit(submitHandler) } noValidate>
              ...
              <div style={{display:'flex',justifyContent:'center', gap:'5px'}}>
                ...
                <Button type="submit" variant="contained">
                  Confirm and Send Credits &nbsp; <SaveAsIcon/>
                </Button>
              </div>
            </form>
          </div>
      ...
      <MessageDialog
        ...
        title={ "Confirmation" } 
        content={ "Are you sure you want to approve request credit?" }
        color={ "success" }
