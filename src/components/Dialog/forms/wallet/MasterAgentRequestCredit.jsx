...
const MasterAgentRequestCredit = ({ isOpenAdd, handleCloseAdd, handleCallback }) => {
  ...
  const [operators, setoperator] = React.useState([]);

  const handleDownlineData = async () => {
    setPageLoader(true);
    let url = `${process.env.REACT_APP_API_URL}/operators/company/${loginObj.companyId}`;
              ...
              <div className="divContent">
                ...
                <div className="right">
                  <TextField 
                    ...
                    { 
                        ...register("operatoruserid", { required: true }) 
                    }
                    error={ !!errors.operatoruserid }
                    helperText={ errors.operatoruserid?.message }
                    ...
                    { 
                        (operators.length !== 0) ? operators.map((item) => (
