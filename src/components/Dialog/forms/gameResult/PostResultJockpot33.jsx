...
const PostResultJockpot33 = ({ isOpenAdd, handleCloseAdd, handleCallback }) => {
  ...
  const handleOkay = async () => {
    ...
    let submitData = {
        ...
        numresult: `${formData.numresult1}-${formData.numresult2}-${formData.numresult3}-${formData.numresult4}-${formData.numresult5}-${formData.numresult6}`.toUpperCase(),
    }
    ...
    // }
    toast.success(`Jackpot 3.3 game result posted successfully.`);
    reset(formValues => ({
        ...formValues,
        gametype: "02",
        drawtype: "",
    ...
    <>
      ...
      >
        <div className="dialogHeader">
          <div className="rd">Game Result Jackpot 3.3</div>
        </div>
            ...
            <form onSubmit={ handleSubmit(submitHandler) } noValidate> 
              ...
              <div>
                <p style={{fontSize:'15px', textTransform:'none'}}>
                    ...
                    The last three boxes takes letters H,S,C,D only.
                </p>
                <p style={{fontSize:'15px', textTransform:'none'}}>
...
export default PostResultJockpot33
