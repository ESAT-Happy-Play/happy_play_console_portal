...
const AddOperator = ({ isOpen, handleClose, handleBack, companyId, branchId, branchName }) => {

  const formOperator = useForm({ defaultValues: UserModel.OperatorForm });
  ...
  const [openConfirmOperatorSubmit, setConfirmOperatorSubmit] = React.useState(false);
  const handleOperatorSubmitOpen = () => { setConfirmOperatorSubmit(true); };
  const handleOperatorSubmitClose = () => { setConfirmOperatorSubmit(false); };
    ...
    <>
      ...
      >
        <div className="dialogHeader">
          ...
          <div className="rd">NEW OPERATOR</div>
        </div>
      ...
      <MessageDialog
        isOpenMessage={ openConfirmOperatorSubmit } 
        handleCloseMessage={ handleOperatorSubmitClose } 
